...
from dorasuper.emoji import E_NOTE, E_SEARCH, E_WARN
...
responses = [
    "Ai gọi DoraSuper đấy? 🧐",
    "Nhắc đến DoraSuper làm gì thế? 😎",
    ...
    "Tèo nghe rõ, sao cơ? 🎧",
    "Lại là DoraSuper, chắc có chuyện gì hệ trọng! 😳",
    "Bạn vừa nhắc đến Tèo hả? Cẩn thận đó! 🤨",
    "Tèo sắp bùng nổ vì bị gọi quá nhiều rồi! 💥",
    "Ai lại đang tìm DoraSuper lừng danh Tèo vậy? 🕵️",
    f"Gọi Tèo một phát, chắc chắn có điều bí ẩn! {E_SEARCH}",
    f"Nhắc đến Tèo là phải cẩn trọng nhé! {E_WARN}",
    ...
    "Tèo đây, ai gọi thế? 🤗",
    f"Gọi Tèo thì phải có lý do chính đáng nhé! {E_NOTE}",
